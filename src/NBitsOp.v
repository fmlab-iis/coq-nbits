...
(*
  Lemma to_Zpos_neq0 sb2 : to_Zpos sb2 <> 0%Z <-> ~~ (sb2 == zeros (size sb2)).
  Proof.
  Admitted.

  Lemma to_Zneg_neq0 sb : ~~ (sb == zeros (size sb)) -> (0 < Z.succ (to_Zneg sb))%Z.
  Proof.
  Admitted.*)
  ...
  Lemma to_Zpos_sdivB_same_msb sb1 sb2 :
